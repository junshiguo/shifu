...
public class NormalizeXGBUDF extends AbstractTrainerUDF<Tuple> {
    ...
    public NormalizeXGBUDF(String source, String pathModelConfig, String pathColumnConfig) throws Exception {
    ...
    public NormalizeXGBUDF(String source, String pathModelConfig, String pathColumnConfig, String isForClean)
            throws Exception {
